...
{
    [Serializable]
    [KnownType(typeof(ProductPartBlockSheet))]
    [MetadataType(typeof(ProductPartBlockSheet_MetaData))]
    public partial class ProductPartBlockSheet : ProductPart,  ICloneable, IDeleteRelated
    {

        public ProductPartBlockSheet()
        {
            TypeOfProductPart = ProductPart.ProductPartType.ProductPartBlockSheet;
        }
        ...
        public virtual void Copy(ProductPartBlockSheet to)
        {
        ...
        public object Clone()
        {
            ...
            ProductPartBlockSheet copyOfObject = (ProductPartBlockSheet)Activator.CreateInstance(kindOfObject);
