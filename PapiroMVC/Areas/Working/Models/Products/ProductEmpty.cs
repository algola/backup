...
namespace PapiroMVC.Models
{
    ...
    public partial class ProductEmpty : Product, IDataErrorInfo, ICloneable, IDeleteRelated
    {

        public ProductEmpty()
        {
            this.TypeOfProduct = ProductType.ProductEmpty;
        }
        ...
        public override string ToString()
        {
            ...
            var s = String.Empty; // (string)t.GetProperty("CodMenuProduct" + this.CodMenuProduct).GetValue(null, null);
        ...
        public virtual void Copy(ProductEmpty to)
        {
        ...
        public object Clone()
        {
            ...
            ProductEmpty copyOfObject = (ProductEmpty)Activator.CreateInstance(kindOfObject);
