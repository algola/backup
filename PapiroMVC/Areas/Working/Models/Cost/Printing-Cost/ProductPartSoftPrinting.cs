...
namespace PapiroMVC.Models
{
    ...
    public partial class ProductPartSoftPrinting : ProductPartRollPrinting
    {
        public ProductPartSoftPrinting()
        {
            TypeOfProductPartPrinting = ProductPartPrintingType.ProductPartSoftPrinting;
        }
