...
{
    public partial class ProductPartPrintingRollGainSingle : ProductPartPrintingRollGain
    {
        //SETUPS
        //------------------------------------------------------------------------------------------------------------------------
        ...
        protected override Makeready CalculateShapeOnBuyingFormat()
        {
            ...
            try
            {
                int gain1_1 = (int)decimal.Truncate((decimal)(Convert.ToDouble(Width) / SmallerFormat.GetSide1()));
                int gain2_2 = (int)System.Math.Ceiling(Convert.ToDecimal(SubjectNumber / gain1_1));

                var gSideOnSide = gain1_1 * gain2_2;

                var gain1_2 = (int)decimal.Truncate((decimal)(Convert.ToDouble(Width) / SmallerFormat.GetSide2()));
               ...
               // gr.TypeOfPerfecting = "";
                ...
                gr.CalculatedGain = gr.PrintedShapes / gr.PrintedSubjects * gr.PrintedShapes;
