...
namespace Services
{
    public class ProductRepository : GenericRepository<dbEntities, Product>, IProductRepository
    {
        ...
        public override void Edit(Product entity)
        {
            ...
            (System.Web.HttpContext.Current.Session["prSession"])=entity;
        }
        ...
        public Product GetSingle(string codProduct)
        {
            ...
            if (prSession == null || prSession.CodProduct != codProduct)
            {
                ...
                System.Web.HttpContext.Current.Session["prSession"] = query;
                prSession = (Product)(System.Web.HttpContext.Current.Session["prSession"]);
